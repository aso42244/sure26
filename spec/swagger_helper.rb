        ...
        schemas: {
          ...
          BudgetSummary: {
            ...
            properties: {
              ...
              name: { type: :string },
              currency: { type: :string },
              cadence: { type: :string, enum: %w[monthly biweekly] },
              anchor_date: { type: :string, format: :date, nullable: true },
          ...
          BudgetCategory: {
            ...
            properties: {
              ...
              display_budgeted_spending: { type: :string },
              display_budgeted_spending_cents: { type: :integer },
              contribution_amount: { type: :string, nullable: true },
              contribution_amount_cents: { type: :integer, nullable: true },
              sinking_fund: { type: :boolean },
              actual_spending: { type: :string },
              actual_spending_cents: { type: :integer },
              available_to_spend: { type: :string },
              available_to_spend_cents: { type: :integer },
              fund_balance: { type: :string, nullable: true },
              fund_balance_cents: { type: :integer, nullable: true },
              category: {
                type: :object,
                required: %w[id name color lucide_icon],
                properties: {
