...
if include_derived_amounts
  ...
  json.rollover_balance budget_category.rollover_balance_money&.format
  json.rollover_balance_cents money_to_minor_units.call(budget_category.rollover_balance_money)
end
